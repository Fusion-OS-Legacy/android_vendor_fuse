...
# Copyright (C) 2020-21 StormbreakerOSS
# Copyright (C) 2020-21 FusionOS
#
...
custom_dependencies = "fusion.dependencies"
org_manifest = "github/Fusion-OS"  # leave empty if org is provided in manifest
org_display = "fusion-os"  # needed for displaying
