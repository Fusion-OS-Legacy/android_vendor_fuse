...
PLATFORM_FUSE_RELEASE := 2.0-Ruka
...
ifeq ($(TARGET_BUILD_VARIANT),OFFICIAL)
    ...
    PROD_VERSION += FusionOS-$(PLATFORM_FUSE_RELEASE)_$(TARGET_DEVICE)-$(shell date +%m%d)-OFFICIAL
else
    PLATFORM_FUSE_VERSION := $(PLATFORM_FUSE_RELEASE)
    PROD_VERSION += FusionOS-$(PLATFORM_FUSE_RELEASE)_$(TARGET_DEVICE)-$(shell date +%m%d)-UNOFFICIAL
endif
